        ...
        <div className="bg-black xl:h-screen flex items-center justify-center text-white px-4 sm:px-6 lg:px-8 h-full py-10 ">
            <div className="w-[40%] mx-auto bg-[#1C1C1C] py-6 px-10 ">
                <div className="h-fit w-full flex flex-col items-center ">
                    <h1 className="text-[1.65rem] md:text-3xl lg:text-3xl">Edit Admin</h1>
                    <p className="text-xl font-[100] pt-2 text-center text-blue-100 ">Edit existing admin in the system.</p>
                    ...
                    <form className="flex flex-col items-center w-full" action="" method="">
                        ...
                        <button className="w-full sm:w-96 h-16 mt-10 text-2xl text-white bg-black border border-white rounded hover:bg-white hover:text-black focus:outline-none " type="submit" onClick={handleSubmit}>Update Admin</button>
                    </form>
                </div>
            </div>
        </div>
